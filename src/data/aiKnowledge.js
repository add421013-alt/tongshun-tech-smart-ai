...
export const aiFallbackAnswer =
  '您好，這部分我可以先協助您初步了解。若涉及正式規格、價格、庫存、保固、維修或企業採購，我會建議您留下預約資訊，由專人依您的使用情境、款式與顏色需求協助確認，會更準確。';
...
export const aiKnowledge = [
  ...
  },
  {
    ...
    answer:
      '智慧音訊眼鏡結合眼鏡外型與音訊功能，適合日常通勤、辦公、通話、教學與商務場合使用。不同款式在外型、材質與風格上會有差異，實際配戴感若您希望比較配戴感或實際使用情境，建議預約讓專人協助確認。',
  },
  {
    keywords: ['推薦', '怎麼選', '選哪款', '適合我', '不知道選'],
    answer:
      '我先幫您簡單分類：日常通勤、辦公與長時間配戴可先看 TBI1001 / TBI1002；正式商務、會議、接待場合可優先看 TBM1003 / TBM1004。若您重視臉型、顏色與配戴感，您也可以透過預約頁留下需求，讓專人協助您比對適合的款式。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '充電與續航會依使用方式、音量、通話時間與環境有所不同。若遇到充電異常，建議先確認充電線、接點與電源來源；若仍無法改善，可以聯繫真人客服協助確認，我也可以先幫您整理需要提供的資訊。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '庫存與到貨狀況會隨時間變動，AI 無法保證即時庫存。建議透過預約或客服確認目前可提供的款式、顏色與服務安排，我也可以引導您前往預約頁。',
  },
  {
